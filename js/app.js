...
function renderBanner(){
  ...
  // duplicate the set once so the loop has no visible seam
  ...
  // set scroll duration from actual content width so speed (px/sec)
  // stays constant no matter how many images you add
